...
/usr/local/cuda/bin/nvcc -arch=sm_35 -c -I/usr/local/cuda/include kernel.cu -lnvidia-ml -lcudart -lcublas -lcuda 
/usr/local/cuda/bin/nvcc -arch=sm_35 -c -I/usr/local/cuda/include qr_code.cpp
/usr/local/cuda/bin/nvcc -arch=sm_35 -o a.out -Xcompiler -fopenmp qr_code.o kernel.o -L/usr/local/cuda/lib64 -L/usr/lib/x86_64-linux-gnu -lnvidia-ml -lcudart -lcublas
