...
/usr/local/cuda/bin/nvcc -c -I/usr/local/cuda/include qr_code.cu
/usr/local/cuda/bin/nvcc -o a.out -Xcompiler -fopenmp qr_code.o -L/usr/local/cuda/lib64 -L/usr/lib/x86_64-linux-gnu -lnvidia-ml -lcudart -lcublas -lcusolver
